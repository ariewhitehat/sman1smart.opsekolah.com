...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-custom fixed-top">
        <div class="container">
            <a class="navbar-brand" href="home">SMAN 1 SMART</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#tas">SPE-TU</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container">
            <div class="row">
                ...
                <!-- <div class="row justify-content-around mb-4">
                    <div class="col-sm-4">
                        <h3 class="d-flex justify-content-between align-items-center mb-3">
                            <span class="text-warning"><i class="bi bi-envelope"></i> Hubungi Kami</span>
                        </h3>
                ...
                <div class="row justify-content-around mt-4">
                    <div class="col-sm-6">
                        <p>
                            <i class="bi bi-geo-alt-fill"></i> Jalur 3 Desa Sumber Jaya Kec. Sumber Marga Telang Kab. Banyuasin Prov. Sumatera Selatan - 30977
                        </p>
    ...
    <!-- End of Kontak -->
    <!-- <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        <path fill="#ffd700" fill-opacity="1" d="M0,160L18.5,149.3C36.9,139,74,117,111,106.7C147.7,96,185,96,222,112C258.5,128,295,160,332,170.7C369.2,181,406,171,443,154.7C480,139,517,117,554,112C590.8,107,628,117,665,133.3C701.5,149,738,171,775,181.3C812.3,192,849,192,886,160C923.1,128,960,64,997,74.7C1033.8,85,1071,171,1108,192C1144.6,213,1182,171,1218,176C1255.4,181,1292,235,1329,245.3C1366.2,256,1403,224,1422,208L1440,192L1440,320L1421.5,320C1403.1,320,1366,320,1329,320C1292.3,320,1255,320,1218,320C1181.5,320,1145,320,1108,320C1070.8,320,1034,320,997,320C960,320,923,320,886,320C849.2,320,812,320,775,320C738.5,320,702,320,665,320C627.7,320,591,320,554,320C516.9,320,480,320,443,320C406.2,320,369,320,332,320C295.4,320,258,320,222,320C184.6,320,148,320,111,320C73.8,320,37,320,18,320L0,320Z"></path>
    </svg> -->
    <!-- Begin of Tas -->
